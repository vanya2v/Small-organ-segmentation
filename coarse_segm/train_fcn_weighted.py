...
#    print('feat x1', np.shape(features['x'][0, 0, :, :, 0]))
...
#    train_filenames = all_filenames[0:47:2]
#    val_filenames = all_filenames[1:47:2]

    train_filenames = all_filenames[1:48:2]
    val_filenames = all_filenames[0:48:2]
    
#    train_1 = all_filenames[0:7]
#    train_2 = all_filenames[14:34]
#    train_filenames = np.concatenate((train_1, train_2), axis = 0)
#    val_filenames = all_filenames[7:14]

    # Set up a data reader to handle the file i/o.
    reader_params = {'n_examples': 57, 
                     'example_size': [64, 64, 64],
                     'classes': NUM_CLASSES,
                     'extract_examples': True} #144
    ...
    nn = tf.estimator.Estimator(
        ...
        params={"learning_rate": 0.001}, #0.00001
...
#            print('Step', MAX_STEPS // EVAL_EVERY_N_STEPS)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_csv', default='malibo_C19.csv')
